...
class Test:
    ...
    def __init__(self):
        ...
        self.codelist=['rb1809','hc1901','m1901','c1901','i1901','CF901','ap901','ru1809']
...
#        def aaa():
#                t.delete(1.0, 'end')
#                t.insert('end', self.datas.price[1])
#                t.after(1000, aaa)
#                
#        root = tkinter.Tk()
#        t = tkinter.Text(root)
...
#        root.mainloop()
        #b=self.ff.LastPrice 
            ...
            #code=self.ff.getInstrumentID()
            #if timea-self.datas.index[-1]>5:
            #self.a=time.time()
        #if timeb-self.a>5:
        #    self.a=time.time()
        #    print(self.datas)  
